...
| `tst_homemodel` | `LightOnModel::clear()` vide bien `onCache` : pas de lumières fantômes après reconnexion (T06) | `HomeModel.cpp`, `RoomModel.cpp`, `HardwareUtils*` (+ doublure locale `FakeConnection`, cf. T18) |
